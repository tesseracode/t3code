...
```
 ...
 .tpatch/features/copilot-skill-controls/record.md  |   51 +-
 .../features/copilot-skill-controls/status.json    |    4 +-
 ...
 .../effort-theming/artifacts/post-apply-diff.txt   |   53 +-
 .../effort-theming/artifacts/post-apply.patch      | 3802 +++++++++++++-
 .tpatch/features/effort-theming/record.md          |   61 +-
 .tpatch/features/effort-theming/status.json        |    4 +-
 .../artifacts/post-apply-diff.txt                  |   57 +-
 .../artifacts/post-apply.patch                     | 3790 +++++++++++++-
 .tpatch/features/readme-copilot-notice/record.md   |   64 +-
 .tpatch/features/readme-copilot-notice/status.json |    4 +-
 .tpatch/features/toast-close-button/status.json    |    4 +-
 .../windows-wsl-support/artifacts/post-apply.patch | 5435 +++++++++++++-------
 51 files changed, 46390 insertions(+), 3466 deletions(-)
```
